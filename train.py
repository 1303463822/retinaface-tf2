...
if __name__ == "__main__":
    ...
    #-------------------------------#
    #   主干特征提取网络的选择
    #   mobilenet或者resnet50或者resnet101
    #-------------------------------#
    backbone = "resnet101"
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path = "logs/resnet101/ep150-loss3.547.h5"
    ...
    if backbone == "mobilenet":
        ...
        raise ValueError('Unsupported backbone - `{}`, Use mobilenet, resnet50, resnet101.'.format(backbone))
